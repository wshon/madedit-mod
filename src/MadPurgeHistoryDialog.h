...
#define MadPurgeHistoryDialog_STYLE wxCAPTION | wxRESIZE_BORDER | wxSYSTEM_MENU | wxSTAY_ON_TOP | wxMAXIMIZE_BOX | wxCLOSE_BOX
////Dialog Style End
...
class MadPurgeHistoryDialog : public wxDialog
{
	...
	private:
		...
		enum
		{
			...
			ID_WXCHECKBOXRECENTSEARCHEDEXCLUDEFILTERS = 1090,
			ID_WXRECENTSEARCHEDFILEFILTERS = 1089,
			ID_WXCHECKBOXRECENTSEARCHEDDIRECTORIES = 1088,
			ID_WXCHECKBOXRECENTREPLACEDTEXTS = 1087,
			ID_WXCHECKBOXRECENTSEARCHEDTEXTS = 1086,
			ID_WXCHECKBOXRECENTENCODINGS = 1085,
			ID_WXCHECKBOXRECENTFONTS = 1084,
			ID_WXCHECKBOXRECENTFILES = 1083,
