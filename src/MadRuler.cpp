...
\class MadRuler
\brief Used to display a MadRuler.
  ...
  In addition to Real numbers, the MadRuler currently supports
...
\class RulerPanel
\brief RulerPanel class allows you to work with a MadRuler like
  any other wxWindow.

*//***************************************************************//**

\class MadRuler::Label
\brief An array of these created by the MadRuler is used to determine
what and where text annotations to the numbers on the MadRuler get drawn.

\todo Check whether MadRuler is costing too much time in malloc/free of
array of MadRuler::Label.
...
wxColour MadRuler::mTickColour( 153, 153, 153 );
   ...
   : mpNumberScale(0)
{
   ...
   // Invalidate is called on a horizontal MadRuler, unless the user
...
void MadRuler::SetTwoTone(bool twoTone)
{
   mTwoTone = twoTone;
}

void MadRuler::SetFormat(RulerFormat format)
{
...
void MadRuler::SetUnits(const wxString &units)
{
...
void MadRuler::SetOrientation(int orient)
{
...
void MadRuler::SetRange(double min, double max)
{
   SetRange(min, max, min, max);
}

void MadRuler::SetRange
...
void MadRuler::SetSpacing(int spacing)
{
   mHasSetSpacing = true;
...
void MadRuler::SetLabelEdges(bool labelEdges)
{
...
void MadRuler::SetFlip(bool flip)
{
...
void MadRuler::SetMinor(bool value)
{
   mbMinor = value;
}

void MadRuler::SetFonts(const wxFont &minorFont, const wxFont &majorFont, const wxFont &minorMinorFont)
{
...
void MadRuler::SetNumberScale(const NumberScale *pScale)
{
   if (!pScale) {
      if (mpNumberScale) {
         delete mpNumberScale;
...
void MadRuler::OfflimitsPixels(int start, int end)
{
   int i;
...
void MadRuler::SetBounds(int left, int top, int right, int bottom)
{
...
void MadRuler::FindLinearTickSizes(double UPP)
{
...
wxString MadRuler::LabelString(double d, bool major)
{
...
void MadRuler::Tick(int pos, double d, bool major, bool minor)
{
   wxString l;
   ...
   // MadRuler code currently does  not handle very small or
...
void MadRuler::TickCustom(int labelIdx, bool major, bool minor)
{
...
// ********** Draw grid ***************************
void MadRuler::DrawGrid(wxDC& dc, int length, bool minor, bool major, int xOffset, int yOffset)
{
...
int MadRuler::FindZero(Label * label, const int len)
{
   int i = 0;
...
void MadRuler::GetMaxSize(wxCoord *width, wxCoord *height)
{
   if (!mValid) {
      wxScreenDC sdc;
      mDC = &sdc;
...
void MadRuler::SetCustomMode(bool value) { mCustom = value; }

void MadRuler::SetCustomMajorLabels(wxArrayString *label, int numLabel, int start, int step)
{
   int i;
...
void MadRuler::SetCustomMinorLabels(wxArrayString *label, int numLabel, int start, int step)
{
   int i;
...
void MadRuler::Label::Draw(wxDC&dc, bool twoTone) const
{
   if (text != wxT("")) {
