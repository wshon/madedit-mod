...
#ifdef _WIN64
wxString g_MadEdit_Version(wxT("MadEdit-Mod 0.3.4.1 win64"));
#else
wxString g_MadEdit_Version(wxT("MadEdit-Mod 0.3.4.1 win32"));
#endif
#elif defined(__WXMAC__)
wxString g_MadEdit_Version(wxT("MadEdit-Mod 0.3.4.1 MacOS"));
#else //Linux
#if defined(__x86_64__) || defined(__LP64__)
wxString g_MadEdit_Version(wxT("MadEdit-Mod 0.3.4.1 x86_x64"));
#else
wxString g_MadEdit_Version(wxT("MadEdit-Mod 0.3.4.1 i686"));
#endif
#endif
